"""
Task 4: Logical and Arithmetic Operations on Images
...
def display_operations(img1_name, img1, img2_name, img2, results):
    ...
    axes[3, 1].set_title("Subtraction (Absolute Diff)")
    axes[3, 1].axis('off')
    ...
    print("Saved: results/Task_04_Logical_Arithmetic.png")
    plt.show()

def main():
    print("=" * 60)
    print("Task 4: Logical and Arithmetic Operations")
    print("=" * 60)
    ...
    print("Performing logical and arithmetic operations...")
    ...
    print("  - Logical operations (AND, OR, XOR, NOT)")
    print("  - Arithmetic operations (Add, Subtract, Multiply, Average)")
